---
source: (our own — research backing the methods-on-types rule)
fetched: 2026-04-27
---

# Methods on types, not free functions — research

*Deep research synthesis on why the
[rust/style.md §"Methods on types"](../rust/style.md) rule is
load-bearing — for human engineers, for the type system, and
especially for LLM-agent code generators. The working extract
for daily reading lives at
[abstractions.md](abstractions.md); this file is the
citation-bearing source. Companion to
[naming-research.md](naming-research.md) and
[beauty-research.md](beauty-research.md).*
...
This document defends that rule across four traditions:
