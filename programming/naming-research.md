---
source: (our own — research backing the naming rule)
fetched: 2026-04-27
---

# Cryptic naming in code — research backing the naming rule

*Origin: 2026-04-27 — frustration with agents producing
cryptic abbreviated identifiers (`tok`, `ident`, `lex`, `de`,
`op`, `kd`, `pf`, `ctx`) that are unreadable to anyone who
isn't fluent in the in-group programmer dialect. This file is
the research that landed the durable rule. The rule itself
lives in
[mentci AGENTS.md §"Naming — full words by default"](https://github.com/LiGoldragon/mentci/blob/main/AGENTS.md).*
...
here; identical text added to [mentci AGENTS.md](https://github.com/LiGoldragon/mentci/blob/main/AGENTS.md).
...
The rule lives in [mentci AGENTS.md](https://github.com/LiGoldragon/mentci/blob/main/AGENTS.md) — the
